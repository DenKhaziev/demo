...
class CertificateUploadedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->subject('Справка готова')
        ->greeting('Добрый день!') 
        ->line('Справка о прохождении промежуточной аттестации по ученику ' . $this->document->child->name . ' загружена.')
