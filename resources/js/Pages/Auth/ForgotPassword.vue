...
<template>
    ...
    <GuestLayout>
        ...
        <div class="mb-4 text-sm text-gray-600">
            Забыли пароль? Не проблема. Просто укажите свой адрес электронной почты, и мы отправим вам ссылку для сброса пароля, с помощью которой вы сможете установить новый пароль.
        </div>
